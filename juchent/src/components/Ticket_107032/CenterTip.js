...
class CenterTip extends Component{
    render(){
        return(
            <div data-v-277f55d8 className="t-detail__plus-tips">
                <div data-v-258e436c data-v-277f55d8 className="t-card-plus-tips">
                    <div data-v-04cd81ad data-v-258e436c className="t-base-tips">
                        <img data-v-04cd81ad 
                        ...
                        className="t-base-tips__icon"
                        /> 
                        <div data-v-04cd81ad className="t-base-tips__name">专享7.5折起</div> 
                        <div data-v-04cd81ad className="t-base-tips__time">最高省170元</div>
                        <div data-v-04cd81ad className="t-base-tips__time-desc"></div> 
                        <div data-v-04cd81ad className="t-base-tips__guide">开通99/年</div> 
                        <i data-v-04cd81ad className="iconfont icon-you t-base-tips__arrow"></i>
                    </div> 
                </div>
            </div>
        )
